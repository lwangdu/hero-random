...
// 1) Wrapper attributes include block supports such as custom classes and anchors.
...
$field_keys = array( 'hero_random', 'gallery' );
$images     = null;
...
// 5) InnerBlocks template: heading, subheading, and buttons.
$template       = array(
	array(
		'core/heading',
		array(
...
?>
<?php // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_block_wrapper_attributes() returns escaped attributes. ?>
	...
	<div class="hero-overlay">
		...
		<?php else : ?>
			<?php if ( ! empty( trim( $content ) ) ) : ?>
				<div class="hero-content">
					<?php echo wp_kses_post( $content_with_id ); ?>
				</div>
			<?php endif; ?>
		<?php endif; ?>
	</div>
